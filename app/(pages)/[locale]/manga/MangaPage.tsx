...
import FilterInputs from "@/app/(pages)/[locale]/manga/_components/FilterInputs";
import ClearFiltersButton from "@/app/(pages)/[locale]/manga/_components/ClearFiltersButton";
import SortButton from "@/app/(pages)/[locale]/manga/_components/SortButton";
...
export default function MangaPage() {
  ...
  return (
      <div className="mx-3 flex flex-col gap-3">
        <h1 className="text-xl">{t("catalog")}</h1>
        <Input
