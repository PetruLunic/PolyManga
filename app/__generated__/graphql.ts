...
export type MangaEditQuery = { __typename?: 'Query', manga?: { __typename?: 'Manga', id: string, title: string, author: string, status: ComicsStatus, type: ComicsType, genres: Array<ComicsGenre>, description: string, releaseYear: number, image: string } | null };
